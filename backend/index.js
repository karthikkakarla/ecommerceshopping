...
mongoose.connect('mongodb+srv://karthiknani02:199024kk@cluster0.es1xq2v.mongodb.net/E-commerce');
...
app.post("/upload", upload.single('product'), (req, res) => {
  res.json({
      success : 1,
      image_url: `https://ecommerceshopping.onrender.com/images/${req.file.filename}`,
  });
});
...
app.get('/newarrivals', async (req, res) => {
    ...
    console.log("NewArrivals Fetched");
    res.send(newarrivals);
});

//Creating endpoint for bestsellers section
app.get('/bestsellers', async (req, res) => {
    let products = await Product.find({category: "oral"});
...
//creating endpoint for removing productsin cartdata
...
//creatting endpoint to get cart data
